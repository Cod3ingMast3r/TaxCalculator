...
def yearOrHour(answer):
    ###################### Income Input Start ###########################################################################################
    if answer == "Year":
        income = float(my_income.text())
    elif answer == "Hour":
...
def calculate():
    income = 0;
    yearOrHour(yearOrHour_combo.currentData())
    incomeTax(income);
...
class MainWindow(qtw.QWidget):
    def __init__(self):
        ...
        yearOrHour_combo = qtw.QComboBox();
        yearOrHour_combo.addItem("/Yr", "Year");
        yearOrHour_combo.addItem("/Hr", "Hour");
        self.layout().addWidget(yearOrHour_combo);
